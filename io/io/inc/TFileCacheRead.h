...
protected:
   ...
   Bool_t         fEnableBuffering;  ///< buffer remote files on local disk
...
public:
   ...
   virtual Bool_t      IsEnableBufferRead() const {return fBufferFile.get();}
   virtual Long_t      GetBufferedBlocks() const;
