...
if(mathmore OR builtin_gsl)
  if(builtin_gsl AND NO_CONNECTION)
    message(FATAL_ERROR "No internet connection. Please check your connection, or disable the 'builtin_gsl' option")
  endif()
  message(STATUS "Looking for GSL")
  if(NOT builtin_gsl)
    find_package(GSL 1.10)
    if(NOT GSL_FOUND)
      message(FATAL_ERROR "GSL package not found and 'mathmore' component if required. "
...
if(builtin_openssl)
  if(NO_CONNECTION)
    message(FATAL_ERROR "No internet connection. Please check your connection, or disable the 'builtin_openssl' option")
  else()
...
if(builtin_fftw3 AND NO_CONNECTION)
  message(FATAL_ERROR "No internet connection. Please check your connection, or disable the 'builtin_fftw3'")
endif()
...
if(fitsio OR builtin_cfitsio)
  if(builtin_cfitsio AND NO_CONNECTION)
    message(FATAL_ERROR "No internet connection. Please check your connection, or disable the 'builtin_cfitsio' option")
  endif()
  if(builtin_cfitsio)
...
if(builtin_xrootd AND NO_CONNECTION)
  message(FATAL_ERROR "No internet connection. Please check your connection, or disable the 'builtin_xrootd' option")
endif()
if(builtin_xrootd)
...
if(builtin_davix)
  if(NO_CONNECTION)
    message(FATAL_ERROR "No internet connection. Please check your connection, or disable the 'builtin_davix' option")
  else()
...
if(builtin_tbb AND NO_CONNECTION)
  message(FATAL_ERROR "No internet connection. Please check your connection, or disable the 'builtin_tbb' option")
endif()
...
if(vc AND NOT Vc_FOUND AND NO_CONNECTION)
  message(FATAL_ERROR "No internet connection. Please check your connection, or disable the 'vc' option")
endif()
...
if(builtin_veccore AND NO_CONNECTION)
  message(FATAL_ERROR "No internet connection. Please check your connection, or disable the 'builtin_veccore' option")
endif()
...
if(builtin_vdt AND NO_CONNECTION)
  message(FATAL_ERROR "No internet connection. Please check your connection, or disable the 'builtin_vdt' option")
endif()
...
if(tmva)
  ...
  if(tmva-pymva)
    if(NOT NUMPY_FOUND OR (NOT PYTHONLIBS_FOUND AND NOT Python2_Interpreter_Development_FOUND AND NOT Python3_Interpreter_Development_FOUND))
...
#---Check for PyROOT---------------------------------------------------------------------
if(pyroot)
  if(NOT PYTHONLIBS_FOUND AND NOT Python2_Interpreter_Development_FOUND AND NOT Python3_Interpreter_Development_FOUND)
  ...
  if(pyroot2 AND NOT Python2_Interpreter_Development_FOUND)
  ...
  if(pyroot3 AND NOT Python3_Interpreter_Development_FOUND)
...
if (testing)
  if (NOT builtin_gtest)
    ...
    if(NO_CONNECTION)
      message(FATAL_ERROR "No internet connection. Please check your connection, or either disable the 'testing' option or the 'builtin_gtest' option")
    endif()
  endif()
endif()
...
if(webgui AND NOT builtin_openui5 AND NO_CONNECTION)
  message(FATAL_ERROR "No internet connection. Please check your connection, or either enable the 'builtin_openui5' option to automatically disable options requiring internet access")
endif()
