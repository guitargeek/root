...
int mnvert(ROOT::Minuit2::MnAlgebraicSymMatrix &a)
{
   unsigned int nrow = a.Nrow();
   ROOT::Minuit2::MnAlgebraicVector s(nrow);
   ROOT::Minuit2::MnAlgebraicVector q(nrow);
   ROOT::Minuit2::MnAlgebraicVector pp(nrow);
