...
TH1::EInconsistencyBits
TH1::LoggedInconsistency(const char *name, const TH1 *h1, const TH1 *h2, bool useMerge) const
{
...
TH1::EInconsistencyBits TH1::CheckConsistency(const TH1* h1, const TH1* h2)
{
