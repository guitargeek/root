...
from support import setup_make, pylong, pyunicode, maxvalue, ispypy, no_root_errors, cppyy_test_load_reflection_info
...
class TestSTLVECTOR:
    def setup_class(cls):
        ...
        import cppyy
        cls.stltypes = cppyy_test_load_reflection_info(cls.test_dct)
        cls.N = global_n
