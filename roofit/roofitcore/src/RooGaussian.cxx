...
RooGaussian::RooGaussian(const char *name, const char *title, RooAbsReal::Ref _x, RooAbsReal::Ref _mean,
                                                     ...
                                                     RooFit::Detail::CodeSquashContext &ctx) const
{
   ...
   return ctx.buildCall("RooFit::Detail::AnalyticalIntegrals::gaussianIntegral", integrand.min(rangeName),
                        integrand.max(rangeName), constant, sigma);
}
