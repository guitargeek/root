...
private:
   ...
   using Func = float (*)(float *, float const *, float const *);
   using Grad = void (*)(float *, float const *, float const *, float *);
   ...
   mutable std::vector<float> _gradientVarBuffer;
   std::vector<float> _observables;
