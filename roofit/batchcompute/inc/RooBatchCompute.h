...
virtual void compute(const RooAbsReal* caller, Computer computer, RunContext& evalData, const std::vector<const RooAbsReal*>& vars, const std::vector<RooSpan<const double>>& spans) = 0; 
      virtual RooSpan<double> computeArgusBG(const RooAbsReal*, RunContext&, std::vector<RooAbsReal*> , RooSpan<const double> , RooSpan<const double> , RooSpan<const double> , RooSpan<const double> ) {return{};}
